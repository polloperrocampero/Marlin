...
#define STRING_CONFIG_H_AUTHOR "(DCG, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ENDER 3 Pol"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 45.24
  #define DEFAULT_bedKi 8.82
  #define DEFAULT_bedKd 154.74
